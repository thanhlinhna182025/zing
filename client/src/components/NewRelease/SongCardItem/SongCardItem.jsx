...
const SongCardItem = ({ item }) => {
  ...
  return (
    <div
      className={`group relative flex h-[80px] cursor-pointer items-center gap-x-2 rounded-md px-2 hover:shadow hover:md:shadow-md hover:lg:shadow-lg ${ColorHoverBg200}`}
    >
