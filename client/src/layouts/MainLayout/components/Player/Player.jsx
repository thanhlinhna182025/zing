...
const Player = () => {
  ...
  return (
    <div
      className={`${ColorBg400} border-t-solid fixed bottom-0 right-[4px] left-0 z-30 flex h-player-height-sm w-full items-center justify-center border-t border-t-[#414141] px-1 shadow-[0_-4px_8px_rgba(0,0,0,0.5)] md:h-player-height md:justify-between md:px-2 lg:px-5 `}
    >
