    ...
    <div>
      {loading ? (
        ...
        <div className='mt-[100px]'>
          ...
          >
            <div className={`absolute top-0 left-0 right-0 bottom-0 bg-gradient-to-t ${ColorBg300} `}></div>
            <div className={`absolute top-0 left-0 right-0 bottom-0 bg-gradient-to-b ${ColorBg300} `}></div>
