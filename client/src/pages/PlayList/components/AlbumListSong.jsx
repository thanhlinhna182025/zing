  ...
  return (
    <div className=' w-full'>
      <div className='mb-[10px] leading-[21px]'>
        <span className='text-sm font-normal  leading-[1.5] text-white'>Lời tựa </span>
        ...
        <div className='flex w-full items-center'>
          <div className='flex w-1/2 items-center'>
            <div className='mr-3 rounded-[4px] border-[1px] border-solid border-[#7E7A85] p-[1px]'>
              <SortIcon className='text-white' width='10px' height='10px' />
            </div>
            <span className='text-xs font-semibold text-white'>BÀI HÁT</span>
          </div>
          <span className='ml-[10px] flex-1 text-xs font-semibold text-white'>ALBUM</span>
      ...
      <div className='py-[6px]'>
        <span className='font-[Inter] text-xs font-semibold tracking-[-0.1px] text-white'>{song?.total} bài hát</span>
        <b className='px-2 align-top text-[20px] font-black leading-3 text-white'>.</b>
        <span className='font-[Inter] text-xs font-semibold tracking-[-0.1px] text-white'>
