          ...
          <div className='flex-start absolute top-[80px] flex lg:left-[59px] lg:bottom-6 '>
            ...
            <div className='flex flex-col'>
              <div className='mb-[14px] flex items-center'>
                <h3 className='text-[30px] font-bold leading-tight text-light-mode dark:text-dark-mode lg:mr-5 lg:text-[60px] xl:text-shadow-lg'>
                  {poster?.name}
                </h3>
                <Button rounded type='outline' className=' flex h-[52px] w-[52px] items-center justify-center bg-white'>
                  <PlayFullFillIcon className='text-A-0' width='24px' height='25px' />
              ...
              <div className=' flex flex-col justify-start lg:flex-row lg:items-center'>
                ...
                <Button
                  type='primary'
                  rounded
                  className='flex w-fit items-center border-A-0 py-[5px] px-6 drop-shadow-xl hover:bg-opacity-80'
                >
                  <AddUserIcon width='16px' height='16px' className='mr-1 text-light-mode dark:text-dark-mode' />
                  <span className='text-xs font-semibold  text-light-mode dark:text-dark-mode'>QUAN TÂM</span>
                </Button>
